...
NSString* const iPhone15_1 = @"iPhone15,1";
...
- (Hardware)hardware {
    ...
    if ([hardware isEqualToString:iPhone15_1]) return IPHONE_14;
    if ([hardware isEqualToString:iPhone15_2]) return IPHONE_14_PLUS;
    if ([hardware isEqualToString:iPhone15_3]) return IPHONE_14_PRO;
    if ([hardware isEqualToString:iPhone15_4]) return IPHONE_14_PRO_MAX;
